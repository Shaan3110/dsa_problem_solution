...
It's simple we have to make a array of string with number of rows provided. Now if we have index 0 then keep going down as true and it would increase the index. As you reach last start decrementing the index and append characters. In this way at the end you just have to append all the rows string together and solution would be done.
